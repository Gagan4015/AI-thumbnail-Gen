...
export default function StyleSelector({
  ...
  const styleDescriptions: Record<ThumbnailStyle, string> = {
    "Bold & Graphic": "Hign contrat, bold typography, striking visuals",
  ...
  return (
    <div className="relative space-y-3 dark">
      ...
      <button
        ...
        className={`w-full flex items-center justify-between rounded-md border px-4 py-2 text-sm transition border-white/10 ${isOpen ? "bg-white/10" : "hover:bg-white/6"}`}
      >
        <div className="space-y-1">
          <div className="flex itmes-center gap-2 font-medium">
            {styleIcons[value]}
