        ...
        {!isLoading && thumbnail?.image_url && (
          <div className="group relative h-full w-full">
            <img
              ...
              alt={thumbnail.title}
              className="h-full w-full object-cover rounded-lg border border-white/12 shadow-lg"
            />
            ...
            <div className="absolute inset-0 flex items-end justify-center bg-black/10 opacity-0 transition-opacity group-hover:opacity-100">
              <button
                ...
                font-medium transition bg-white/30 ring-2 ring-white/
                40 backdrop-blur hover:scale-105 active: scale-95"
              >
